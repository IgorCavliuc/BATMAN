...
const NavigationProfile = () => {
    return(
        <div className='batman-store__header-profile'>
            ...
            <div className='batman-store__header-profile_name-status'>  <p className='batman-store__header-profile_name'>Toda D</p>
                <p className='batman-store__header-profile_status'>Premium account</p></div>
